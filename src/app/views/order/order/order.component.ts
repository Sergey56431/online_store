...
export class OrderComponent implements OnInit {
  ...
  createOrder() {
    if (this.orderForm.valid && this.orderForm.value.paymentType && this.orderForm.value.email &&
      this.orderForm.value.phone && this.orderForm.value.lastName && this.orderForm.value.firstName) {
      ...
      if (this.orderForm.value.fatherName) {
        paramsObject.comment = this.orderForm.value.fatherName;
      }
